...
declare class ViewService extends BaseModel {
    name: string;
...
declare class Views extends CrudService<ViewService> {
    /**
     * @inheritdoc
     */
    decode(data: {
...
declare module ViewsWrapper {
    export { Views };
}
import ViewService$0 = ViewsWrapper.Views;
...
export { Client as default, ClientResponseError, BaseAuthStore, LocalAuthStore, getTokenPayload, ExternalAuth, Admin, Collection, ViewService as View, Record, ViewRecord, LogRequest, BaseModel, ListResult, SchemaField, RecordAuthResponse, AuthProviderInfo, AuthMethodsList, RecordSubscription, OnStoreChangeFunc, UnsubscribeFunc };
