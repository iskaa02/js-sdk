...
describe('LogService', function () {
    ...
    var service = new LogService(client);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, service.getRequestsList(2, 1, { 'q1': 'abc' })];
                        case 1:
                            list = _a.sent();
                            expected = [new LogRequest({ 'id': 'test123' })];
    ...
    describe('getRequest()', function () {
        it('Should return single request log', function () {
            return __awaiter(this, void 0, void 0, function () {
                var result, expected;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, service.getRequest('test?123', { 'q1': 'abc' })];
                        case 1:
                            result = _a.sent();
                            expected = new LogRequest({ 'id': 'test123' });
    ...
    describe('getRequestsStats()', function () {
        it('Should return array with date grouped logs', function () {
            return __awaiter(this, void 0, void 0, function () {
                var result, expected;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, service.getRequestsStats({ 'q1': 'abc' })];
                        case 1:
                            result = _a.sent();
                            expected = [{ total: 123, date: '2022-01-01 00:00:00' }];
                            assert.instanceOf(result, expected.constructor);
                            assert.deepEqual(result, expected);
                            return [2 /*return*/];
                    }
