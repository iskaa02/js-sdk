    ...
    describe('cookieSerialize()', function () {
        ...
        it('Should generate a cookie with all available options', function () {
            var result = cookieSerialize('test_cookie', 'abc', {
                ...
                priority: "low",
                sameSite: "lax",
                encode: function (val) { return "encode_" + encodeURIComponent(val); },
            });
